...
extension CGFloat {
    ...
    public static let cornerRadius5x: CGFloat = 20
    public static let cornerRadius6x: CGFloat = 24
    ...
    public static let margin5x: CGFloat = 20
    public static let margin6x: CGFloat = 24
    public static let margin7x: CGFloat = 28
    ...
    public static let margin28: CGFloat = 28
    ...
    public static let heightCell44: CGFloat = 44
    public static let heightCell48: CGFloat = 48
    public static let heightCell56: CGFloat = 56
    public static let heightCell64: CGFloat = 64
    public static let heightCell72: CGFloat = 72
    public static let heightCell80: CGFloat = 80
    public static let heightCell88: CGFloat = 88
    public static let heightCell96: CGFloat = 96
    public static let heightButton: CGFloat = 44
    public static let heightBottomWrapperBar: CGFloat = 98

    public static let iconSize6: CGFloat = 6
    public static let iconSize8: CGFloat = 8
    public static let iconSize10: CGFloat = 10
    public static let iconSize12: CGFloat = 12
    public static let iconSize16: CGFloat = 16
    public static let iconSize20: CGFloat = 20
    public static let iconSize24: CGFloat = 24
    public static let iconSize28: CGFloat = 28
    public static let iconSize32: CGFloat = 32
    public static let iconSize48: CGFloat = 48
    public static let iconSize64: CGFloat = 64
}
